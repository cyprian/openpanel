...
declare global {
  namespace PrismaJson {
    ...
    type IPrismaMlImageMetadata = Record<string, unknown>;
    type IPrismaMlEvaluationMetrics = Record<string, unknown>;
    type IPrismaMlEvaluationMetadata = Record<string, unknown>;
